  ...
  module numeron::numeron_monster_catch_attempt_event {
  ...
  public fun new(player: address, monster_id: u256, result: MonsterCatchResult): MonsterCatchAttemptEvent {
    MonsterCatchAttemptEvent {
                                   player,monster_id,result
                               }
  }
}
