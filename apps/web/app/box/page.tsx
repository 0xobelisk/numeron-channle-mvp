...
const ITEMS = [
  {
    ...
    image: 'https://igstatic.igxe.cn/steam/image/730/19cfb9de8d87b53a024570838e277473.png?x-oss-process=image/format,webp',
    rarity: 'legendary',
    wear: 0.03,
    category: 'weapon',
    dropRate: 0.01, // 1%
  },
  {
    ...
    image: 'https://igstatic.igxe.cn/steam/image/730/4d3cd4149cc360c079bd99e265dc2a92.png?x-oss-process=image/format,webp',
    rarity: 'epic',
    wear: 0.12,
    category: 'weapon',
    dropRate: 0.05, // 5%
  },
  {
    ...
    image: 'https://igstatic.igxe.cn/steam/image/730/361282da9b526356602d8d9c3a606fb0.png?x-oss-process=image/format,webp',
    rarity: 'rare',
    wear: 0.25,
    category: 'weapon',
    dropRate: 0.10, // 10%
  },
  {
    id: '104',
    name: 'P90 | Rapid Rush',
    image: 'https://igstatic.igxe.cn/steam/image/730/63daa5e9736f07e62222d76d28c87c78.png?x-oss-process=image/format,webp',
    rarity: 'uncommon',
    wear: 0.45,
    category: 'weapon',
    dropRate: 0.20, // 20%
  },
  {
    ...
    image: 'https://igstatic.igxe.cn/steam/image/730/5e181311c5f449e33deb289f0fa9c5db.png?x-oss-process=image/format,webp',
    rarity: 'common',
    wear: 0.01,
    category: 'weapon',
    dropRate: 0.64, // 64%
...
export default function BoxPage() {
  ...
  const triggerConfetti = () => {
    ...
    // 在窗口中间位置发射彩带
    const colors = wonItem?.rarity === 'legendary' 
        ...
        {!isOpening ? (
              ...
              <div className="grid grid-cols-5 gap-2">
                {ITEMS.map((item) => (
                  ...
                  >
                    ...
                    <div className={`w-full py-2 px-1 text-center text-xs ${
          ...
          <div className="flex flex-col items-center">
            ...
            <h2 className="text-xl font-bold mb-6">
              {BOXES.find(b => b.id === selectedBox)?.name || 'Weapon Box'}
            </h2>
                ...
                {wonItem && (
                  <div className="flex flex-col items-center pt-12 pb-4">
                    <div className={`w-full h-64 ${
                      wonItem.rarity === 'legendary' ? 'bg-yellow-900/30' :
                      wonItem.rarity === 'epic' ? 'bg-purple-900/30' :
                      wonItem.rarity === 'rare' ? 'bg-blue-900/30' :
                      wonItem.rarity === 'uncommon' ? 'bg-green-900/30' : 'bg-gray-900/30'
                    ...
                    <div className="w-full text-center mt-4 text-2xl font-bold">
                      {wonItem.name.split(' | ')[0]} | <span className="text-yellow-400">{wonItem.name.split(' | ')[1] || ''}</span>
                    </div>
