...
export class PreloadScene extends BaseScene {
  ...
  preload() {
    ...
    this.load.image(WORLD_ASSET_KEYS.MAIN_1_BACKGROUND, `${monsterTamerAssetPath}/map/level_background.png`);
    ...
    this.load.image(WORLD_ASSET_KEYS.MAIN_1_FOREGROUND, `${monsterTamerAssetPath}/map/level_foreground.png`);
  ...
  async create() {
    ...
    // First load local storage data
    dataManager.loadData();

    // Then get and update position from the chain
